...
const Header = () => {
    ...
    const lightMode = () => {
      ...
      document.querySelector(".donate-link #donate").style.background = "var(--secondary-light)";
      document.querySelector("#landingSection").style.backgroundColor = "var(--primary-light)";
      document.querySelector(".overlay").style.display = "none";
      document.querySelector("#about").style.backgroundColor = "var(--primary-light)";
      document.querySelector(".who-we-are h2 span").style.backgroundColor = "var(--secondary-light)";
      document.querySelector("#offers").style.background = "var(--primary-light)";
      document.querySelector("#offers h2 span").style.background = "var(--secondary-light)";
      ...
      document.querySelector(".offers-item").style.background = "var(--secondary-light)";
      document.querySelector("#founder").style.background = "var(--secondary-light)";
      document.querySelector(".orange").style.color = "var(--secondary-light)";
      document.querySelector("#contact").style.background = "var(--primary-light)";
    ...
    return (
      ...
      <ul className="color-way">
        <li><div className="light-mode" onClick={lightMode}></div></li>
        <li><div className="dark-mode" onClick={darkMode}></div></li>
      </ul>
        <li className="nav-links"><a href="#about">About</a></li>
        <li className="nav-links"><a href="#contact">Contact</a></li>
        <li className="nav-links donate-link"><a href="/donate" id="donate">Donate</a></li>
      </ul>
    </header>
    )
}
